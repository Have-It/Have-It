...
import com.meta.member.exception.dto.ErrorResponse;
        ...
        @ApiResponse(responseCode = "에러", description = "#### 에러 이유를 확인 하십시오",
                content =@Content(schema = @Schema(implementation = ErrorResponse.class),
                        examples = {
                                ...
                                @ExampleObject( name = "404_NOT FOUND PHOTO" , value = "사진을 찾을 수 없습니다."),
                                @ExampleObject( name = "404_NOT FOUND MEMBER" , value = "맴버를 찾을 수 없습니다."),
                                @ExampleObject( name = "409_FAIL SAVE IMAGE" , value = "사진 저장에 실패했습니다."),
