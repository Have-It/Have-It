package com.meta.member.exception.enums;
...
public enum ErrorCode implements EnumModel{
    ...
    FAIL_SAVE_IMAGE(409, "FAIL SAVE IMAGE", "사진 저장에 실패했습니다."),
    NOT_FOUND(404, "NOT FOUND", "자원이 유효하지 않습니다."),
    NOT_FOUND_PHOTO(404, "NOT FOUND PHOTO", "사진을 찾을 수 없습니다."),
    NOT_FOUND_MEMBER(404, "NOT FOUND MEMBER", "맴버를 찾을 수 없습니다."),
