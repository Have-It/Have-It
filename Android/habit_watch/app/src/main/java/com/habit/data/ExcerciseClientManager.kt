...
private const val TAG = "ExcerciseClientManager"
/**
...
class ExerciseClientManager @Inject constructor(
    ...
    suspend fun getExerciseCapabilities(exercise: ExerciseType): ExerciseTypeCapabilities? {
        val capabilities = exerciseClient.getCapabilities()
        Log.d(TAG, "getExerciseCapabilities: ${exercise.name}")
        return if (exercise in capabilities.supportedExerciseTypes) {
            capabilities.getExerciseTypeCapabilities(exercise)
        } else {
            null
        }
    }
    ...
    suspend fun startExercise(exercise: HabitExerciseType) {
        ...
        val capabilities = getExerciseCapabilities(exercise.exerciseType)
...
//        }
        ...
        logger.log("Started exercise----------- ${exercise.exerciseType}")
    }
